  ...
  <div className="index">
    ...
    <div className="blue-back">
      ...
      <div className="greeting">
        ...
        <h2>3rd year CS Major at Cornell University</h2>
        ...
        <table className="intern-table">
          ...
          <tbody>
            <tr className="intern-head">
              <td>
                <div className="company-flex">
                  <img src={require("./../assets/servicenow.png")}></img>
                  <div>ServiceNow</div>
                </div>
              </td>
            ...
            <tr className="border intern-desc">
              <td colSpan="3">- Designed and implemented plugin load duration tracking during upgrades with 30,000+ WAU<br>
              </br>- Captured plugin/file load times in Upgrade Engine and persisted in a new MariaDB schema<br>
                </br>- Implemented Angular frontend for plugin/plugin file by duration metrics</td>
            </tr>
            <tr className="intern-head">
              <td>
                <div className="company-flex">
                  <img src={require("./../assets/iotex.jpg")}></img>
                  <div>IoTeX</div>
                </div>
              </td>
              <td>Software Engineer Intern</td>
            ...
            <tr class="intern-head">
              <td>
                <div className="company-flex">
                  <img src={require("./../assets/nasa.jpg")}></img>
                  <div>NASA</div>
                </div>
              </td>
            ...
            <tr className="border intern-desc">
              <td colSpan="3">- Coauthored “Mars as a Remnant Planetary Embryo
    ...
    <div className="footer">
      ...
      <br></br>
      Thanks for visiting! LF 2021 internships
    </div>
  </div>
)
